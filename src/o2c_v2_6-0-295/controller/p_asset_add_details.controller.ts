...
@KloUI5("o2c_v2.controller.p_asset_add_details")
export default class p_asset_add_details extends KloController{
	...
	{
		await this.tm.getTN("asset_additional_details_list").createEntityP({}, "Creation Successful", "Creation Failed", null, "First", false, true, false);
	}
}