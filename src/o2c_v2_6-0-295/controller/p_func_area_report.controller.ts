...
@KloUI5("o2c_v2.controller.p_func_area_report")
export default class p_func_area_report extends KloController {
    public onInit() { }
    ...
    public async onPageEnter() {
        ...
        search.functional_view = "FA"
        const currentDate = new Date();
        const currentYear = currentDate.getFullYear();
        const currentMonth = currentDate.getMonth();
        const financialYear = currentMonth < 3 ? currentYear - 1 : currentYear;
        const firstAprilDate = new Date(financialYear, 3, 1);
        search.target_fy = firstAprilDate
