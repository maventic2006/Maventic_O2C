...
@KloUI5("o2c_v2.controller.p_pa_cat_plan_config")
export default class p_pa_cat_plan_config extends KloController{
    ...
    public async onCreateCatPlan(){

        await this.tm.getTN('o2c_pa_plan_apprver_config_list').createEntityP()
        this.setMode("EDIT")
    }
